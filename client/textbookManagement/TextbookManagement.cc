...
TextbookManagement::TextbookManagement( StorageControl *storageControl ) { this->storageControl = storageControl; }

TextbookManagement::~TextbookManagement() {}

void TextbookManagement::addTextbook( QString semester, QString coursecode, QString isbn,
                                      QString title, QString publisher, QString author,
                                      int year, QString edition, QString description,
                                      bool available, float price ) {
...
void TextbookManagement::editTextbook( QString isbn, QString title, QString publisher,
                                       QString author, int year, QString edition, QString description,
                                       bool available, float price, int content_id ) {
...
void TextbookManagement::addChapter( QString title, int chapterNo, QString isbn, QString description,
                                     bool available, float price ) {
...
void TextbookManagement::editChapter( QString title, int chapterNo, QString isbn, QString description,
                                      bool available, float price, int content_id ) {
...
void TextbookManagement::addSection( QString title, int sectionNo, int chapterNo, QString isbn, QString description,
                                     bool available, float price ) {
...
void TextbookManagement::editSection( QString title, int sectionNo, int chapterNo, QString isbn, QString description,
                                      bool available, float price, int content_id ) {
